...
export const PlaylistDetail = (match) => {
  ...
  const playlistSlug = match?.data?.id;
  app.innerHTML = `
    ${Header()}
...
export const setPlaylistDetailRouter = (router) => {
...
function hideLoading() {
  document.querySelector("#playlist-loading-overlay")?.remove();
}
