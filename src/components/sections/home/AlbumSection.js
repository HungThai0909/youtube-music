export const AlbumSection = {
  ...
  renderAlbums() {
    ...
    this.albums.forEach((album) => {
      ...
      card.innerHTML = `
        <div class="group cursor-pointer" data-album-slug="${
          album.slug || album.id || ""
        }">
          <div class="relative">
            <img
            ...
            />
            <button
              class="album-play-btn absolute inset-0 flex items-center justify-center
      ...
      const albumCard = card.querySelector("[data-album-slug]");
