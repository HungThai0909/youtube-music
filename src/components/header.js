export const Header = () => {
  return `
     <header class="fixed top-0 left-0 right-0 z-50 bg-black text-white px-4 py-3 flex items-center gap-4">
      <button class="p-2 hover:bg-gray-800 rounded-full transition-colors cursor-pointer">
      ...
      <div class="flex-1 max-w-2xl mx-auto">
        <div class="relative">
          ...
          <input
            ...
            class="w-full bg-gray-800 text-white placeholder-gray-400 py-3 pl-12 pr-4 focus:outline-none focus:bg-gray-700 transition-colors"
          />
        </div>
      </div>
